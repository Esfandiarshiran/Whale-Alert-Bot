...
def _handle_start(chat_id: str, user_id: str, username: str) -> None:
    ...
    msg = (
        ...
        "━" * 30 + "\n\n"
        "This bot posts real-time whale alerts to Telegram channels.\n\n"
        "✨  WHAT MAKES OUR ALERTS SPECIAL:\n"
        "  • Beautiful royal-themed shareable cards\n"
        "  • Direction analysis (→ sell, ← buy signals)\n"
        "  • Whale Score (0-100) for instant significance\n"
        "  • Cluster detection (4+ whales in 30 min)\n"
        "  • Whale of the Week announcement\n\n"
        "🎨  PERSONALIZE & SHARE:\n"
        "  When you see an alert in a channel, tap 'Personalize & Share'\n"
        "  to get your OWN version of the card with your name on it!\n"
        "  Then share it on Twitter, Telegram, anywhere — it's yours.\n\n"
    )
    if is_adm:
